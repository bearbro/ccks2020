...
# 读取训练集
D = pd.read_csv('./data/ccks2019/ccks2019_event_entity_extract/event_type_entity_extract_train.csv', encoding='utf-8',
                names=['a', 'b', 'c', 'd'])
D = D[D["c"] != u'其他']
...
D = pd.read_csv('./data/ccks2019/ccks2019_event_entity_extract/event_type_entity_extract_eval.csv', header=None,
                names=["id", "text", "event"])
